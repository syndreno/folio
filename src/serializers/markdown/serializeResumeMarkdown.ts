...
export function serializeResumeMarkdown(resume: ResumeDocument): string {
  ...
  const frontMatter = {
    ...
    letter_spacing: resume.design.letterSpacing,
    section_spacing: resume.design.sectionSpacing,
    entry_spacing: resume.design.entrySpacing,
    page_margin: resume.design.pageMargin,
    heading_size: resume.design.headingSize,
    page_size: resume.design.pageSize,
    show_photo: resume.design.showPhoto,
    photo_shape: resume.design.photoShape,
    photo_zoom: resume.design.photoZoom,
    photo_position_x: resume.design.photoPositionX,
    photo_position_y: resume.design.photoPositionY,
